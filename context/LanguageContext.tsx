...
export const translations = {
  pt: {
    ...
    aboutP1: '<strong>Sou Vitor Cardoso</strong>, um desenvolvedor fullstack. Tenho experiência na construção de sistemas de ponta a ponta.',
    aboutP2: 'Meu trabalho abrange backend, frontend, banco de dados, segurança e todo fluxo que envolve a criação de um sistema.',
    aboutP3: 'Acredito que o melhor sistema não é o mais complexo — é o que <strong>agrega valor</strong> aos usuários.',
    stats: [
  ...
  en: {
    ...
    aboutP1: "<strong>I'm Vitor Cardoso</strong>, a fullstack developer with experience building end-to-end systems.",
    aboutP2: 'My work spans backend, frontend, databases, security, and the full flow involved in creating a system.',
    aboutP3: "I believe the best system is not the most complex — it's the one that <strong>delivers value</strong> to users.",
    stats: [
